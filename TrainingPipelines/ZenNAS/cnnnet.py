...
class CnnNet(nn.Module):
    ...
    def __init__(self,
        ...
        #change made for grayscale
        # self.conv1 = nn.Conv2d(
        #     in_channels=1,  # Update input channels to 1 for grayscale images
        #     out_channels=structure_info[0][0],
        #     kernel_size=structure_info[0][1],
        #     stride=structure_info[0][2],
        #     padding=structure_info[0][3],
        # )
